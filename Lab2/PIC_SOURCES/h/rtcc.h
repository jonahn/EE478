 ...
 * Note:            None
 ********************************************************************/
#define mRtccIsWrEn()   (RTCCON1bits.RTCWREN)
 ...
 * Note:            None
 ********************************************************************/
#define mRtccWrOff()   (RTCCON1bits.RTCWREN = 0)
 ...
 * Note:            None
 ********************************************************************/
#define mRtccIsOn()   (RTCCON1bits.RTCEN)
 ...
 * Note:            None
 ********************************************************************/
#define mRtccOff()   (RTCCON1bits.RTCEN=0)
 ...
 *                  TODO: check this is TRUE for PIC24F too.
 ********************************************************************/
#define mRtccOn()   (RTCCON1bits.RTCEN=1)
 ...
 * Note:            None
 ********************************************************************/
#define mRtccIsSync()   (RTCCON1bits.RTCSYNC)
 ...
 * Note:            None
 ********************************************************************/
#define mRtccSetClockOe(enable)   (RTCCON1bits.RTCOE=enable)
 ...
 * Note:            None
 ********************************************************************/
#define mRtccGetClockOe()   (RTCCON1bits.RTCOE)
 ...
 *                  of time. Care must be taken under these circumstances).
 ********************************************************************/
#define mRtccWaitSync()   while((BOOL)RTCCON1bits.RTCSYNC)
 ...
 * Note:            None
 ********************************************************************/
#define mRtccIs2ndHalfSecond()   (RTCCON1bits.HALFSEC)
 ...
 * Note:            It sets the pointer to the min/sec slot
 ********************************************************************/
#define mRtccClearRtcPtr()   (RTCCON1&=~RTCCFG_MASK_RTCPTR)
 ...
 * Note:            macro mRtccClearRtcPtr() must be called prior to this macro
 ********************************************************************/
#define mRtccSetRtcPtr(mask)   (RTCCON1|=mask)
