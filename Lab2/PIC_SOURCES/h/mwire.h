...
#elif defined(MWIRE_IO_V5)

#define   MW1_DO        PORTCbits.RC4        // microwire DO to 18Cxxx
#define   MW1_DO_TRIS   TRISCbits.TRISC4
#define   MW1_DI        PORTCbits.RC5        // microwire DI to 18Cxxx
#define   MW1_DI_TRIS   TRISCbits.TRISC5 
#define   MW1_CLK       PORTCbits.RC3        // microwire clock to 18Cxxx
#define   MW1_CLK_TRIS  TRISCbits.TRISC3

#elif defined(MWIRE_IO_V6)

#define   MW1_DO        PORTBbits.RB3        // microwire DO to 18Cxxx
#define   MW1_DO_TRIS   TRISBbits.TRISB3
#define   MW1_DI        PORTBbits.RB0        // microwire DI to 18Cxxx
#define   MW1_DI_TRIS   TRISBbits.TRISB0 
#define   MW1_CLK       PORTBbits.RB1        // microwire clock to 18Cxxx
#define   MW1_CLK_TRIS  TRISBbits.TRISB1
