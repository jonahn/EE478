/* $Id: can2510.h,v 1.6 2012/09/21 09:16:05 davidras Exp $ */
#ifndef __CAN2510_H
#define __CAN2510_H
...
signed char CAN2510Init( auto unsigned short long BufferConfig,
...
signed char CAN2510SetMsgFilterStd( auto unsigned char bufferNum,
                                      auto unsigned int  mask,
                                      auto unsigned int  *filters );

signed char CAN2510SetMsgFilterXtd( auto unsigned char bufferNum,
                                      auto unsigned long mask,
                                      auto unsigned long *filters );

signed char CAN2510WriteStd( auto unsigned int  msgId,
                               auto unsigned char msgPriority,
                               auto unsigned char numBytes,
                               auto unsigned char *data );

signed char CAN2510WriteXtd( auto unsigned long msgId,
                               auto unsigned char msgPriority,
                               auto unsigned char numBytes,
                               auto unsigned char *data );
...
signed char CAN2510WriteBuffer( auto unsigned char bufferNum );
