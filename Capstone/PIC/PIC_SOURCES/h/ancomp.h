...
#elif defined (ANCOM_V8) || defined (ANCOM_V8_1)
//************* Comparator Ref (CxVREF )select ****************
#define COMP_REF_FVR		0b11111111			//CxVREF input connects to FVR (fixed 1.2V)
...
#define COMP_VINM_MASK		(~COMP_VINM_IN3)	//Mask Comparator negetive terminal input selection bit
		...
		defined (ANCOM_V10_2) || defined (ANCOM_V10_3) || defined (ANCOM_V11)
void Close_ancomp1( void );
void Open_ancomp1(unsigned char config);
void Close_ancomp2( void );
void Open_ancomp2(unsigned char config);

#if defined (ANCOM_V10) || defined (ANCOM_V10_1) || defined (ANCOM_V10_2) || defined (ANCOM_V10_3) || defined (ANCOM_V11)
...
#if defined (ANCOM_V11)
/**************************************************************************
Macro   :  Config_CVREFH(config)

Overview   : This macro configures CVRCONH register

Parameters   : config - This contains the parameters to be configured in the CVRCONH   
                         Register as defined below
...
Remarks      : None                                             
**************************************************************************/
#define Config_CVREFH(config)     (CVRCONH = config)

/**************************************************************************
Macro   :  Config_CVREFL(config)

Overview   : This macro configures CVRCONL register

Parameters   : config - This contains the parameters to be configured in the CVRCONL
                         Register as defined below
			...
			*      CMP_VREF_OUTPUT_MASK
			...
			Comparator VREF Positive Source Selection bit
			*      CMP_VRSRC_VBG
			*      CMP_VRSRC_VREF_PLUS
			*      CMP_VRSRC_AVDD
			*      CMP_VRSRC_MASK
			
			Comparator VREF Negative Source Selection bit
			*      CMP_VNEGSRC_VREF_MINUS
			*      CMP_VNEGSRC_AVSS
			*      CMP_VNEGSRC_MASK
Returns      : None					 
...
Remarks      : None                                             
**************************************************************************/
#define Config_CVREFL(config)     (CVRCONL = config)
#endif
...
#define COMP_VINM_VBG				0b11111111			//Inverting input of comparator connects to VIRV
#define COMP_VINM_CINB				0b11111110			//Inverting input of comparator2 connects to C2IND
#define COMP_VINM_CINC				0b11111101			//Inverting input of comparator connects to CxINC
#define COMP_VINM_C2INB				0b11111100			//Inverting input of comparator connects to CxINB pin
#endif

/*CVRCON register definition*/
#if defined (ANCOM_V10) || defined (ANCOM_V10_1) || defined (ANCOM_V10_2) || defined (ANCOM_V10_3) || defined (ANCOM_V11)
#define CMP_CVREF_ENABLE                 0xFF /* CVREF circuit powered on */
#define CMP_CVREF_DISABLE                0x7F /* CVREF circuit powered down */
...
#if defined (ANCOM_V11)
#define CMP_VRSRC_VBG        		 	 0xEF /* Comparator reference source CVRSRC = VBG */
#define CMP_VRSRC_VREF_VREF        		 0xDF /* Comparator reference source CVRSRC = VREF+ */
#define CMP_VRSRC_AVDD        		 	 0xCF /* Comparator reference source CVRSRC = AVDD */
#else
...
#elif defined (ANCOM_V11)
#define COMP_VINM_VBG				0b00000011			//Inverting input of comparator connects to VIRV
#define COMP_VINM_CINB				0b00000010			//Inverting input of comparator2 connects to CxINB
#define COMP_VINM_CINC				0b00000001			//Inverting input of comparator connects to CxINC
#define COMP_VINM_C2INB				0b00000000			//Inverting input of comparator connects to C2INB pin
#define COMP_VINM_MASK				(~COMP_VINM_VBG)
#endif
...
#if defined (ANCOM_V11)
#define CMP_VRSRC_VBG        		 	 0x20 /* Comparator reference source CVRSRC = VBG */
#define CMP_VRSRC_VREF_VREF        		 0x10 /* Comparator reference source CVRSRC = VREF+ */
#define CMP_VRSRC_AVDD        		 	 0x00 /* Comparator reference source CVRSRC = AVDD */
